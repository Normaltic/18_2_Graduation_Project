...
import { default as Pencil } from 'tools/Pencil.mi';
...
export default (props) => {
	...
	const initialize = (ref) => {
		...
		PenTool = Pencil(canvas.getContext('2d'), canvasRef);
	}
	...
	return (
		<div className="HomeContent_Frame">
			그림 작업 입력을 테스트 해보세요!
			<br /><br />
			<div className="HomeContent_CanvasFrame Static_Flex Static_Flex_Align_Center Static_Flex_Justify_Center">
